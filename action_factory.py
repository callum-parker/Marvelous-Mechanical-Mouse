	...
	def parse_log(log):
		...
		for i in range(0, len(log)-2):
			...
			if log[i][3] == None and log[i][4] == None: # movement only
				...
				new_record["action"] = Action_factory.Action.keypress
